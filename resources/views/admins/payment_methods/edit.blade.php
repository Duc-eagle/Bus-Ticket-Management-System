...
<div class="container-fluid">
    <div class="row mb-4">
        <div class="col-12 d-flex justify-content-between align-items-center">
            <h2 class="mb-0 text-dark fw-bold">Cập nhật Phương thức thanh toán</h2>
        ...
        <div class="card-body p-4">
            <form action="{{ route('paymentMethods.update', $paymentMethod) }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" class="form-control bg-light @error('method_name') is-invalid @enderror" id="method_name" name="method_name" value="{{ $paymentMethod->method_name }}" required>
                    @error('method_name')
                ...
                <div class="mb-4">
                    ...
                    <input type="text" class="form-control bg-light @error('method_description') is-invalid @enderror" id="method_description" name="method_description" value="{{ $paymentMethod->method_description }}" required>
