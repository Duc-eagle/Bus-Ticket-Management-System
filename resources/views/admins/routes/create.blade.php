...
<div class="container-fluid">
    ...
    <div class="row mb-4">
        <div class="col-12 d-flex justify-content-between align-items-center">
            <h2 class="mb-0 text-dark fw-bold">Thêm mới Tuyến đường</h2>
        ...
        <div class="card-body p-4">
            <form action="{{ route('routes.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" class="form-control bg-light @error('route_name') is-invalid @enderror" id="route_name" name="route_name" required>
                    @error('route_name')
                ...
                <div class="mb-4">
                    ...
                    <input type="number" class="form-control bg-light @error('distance') is-invalid @enderror" id="distance" name="distance" min="1" required>
                    @error('distance')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="mb-4">
                    ...
                    <input type="text" class="form-control bg-light @error('estimate_time') is-invalid @enderror" id="estimate_time" name="estimate_time" placeholder="VD: 5 giờ 30 phút" required>
                    @error('estimate_time')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
